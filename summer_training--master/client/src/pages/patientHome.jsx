    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-950 to-black text-white px-6 py-16 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="z-10 max-w-5xl w-full flex flex-col md:flex-row items-center justify-center gap-10 text-center md:text-left">
        ...
        <div className="space-y-6 max-w-lg">
          ...
          <div className="space-y-4 mt-6 flex flex-col max-w-xs">
            <Link to="/patient/appointments" className="px-6 py-3 bg-indigo-700 hover:bg-indigo-800 transition text-white rounded-xl font-semibold shadow-lg text-center">
              📅 Book Appointment
            </Link>
            <Link to="/patient/analyze-report" className="px-6 py-3 bg-pink-600 hover:bg-pink-700 transition text-white rounded-xl font-semibold shadow-lg text-center">
              🔍 Analyze report
            </Link>
            <Link to="/patient/diabetes-prediction" className="px-6 py-3 bg-blue-600 hover:bg-blue-700 transition text-white rounded-xl font-semibold shadow-lg text-center">
              🩸 Diabetes Prediction
            </Link>
            <Link to="/patient/heart-disease-prediction" className="px-6 py-3 bg-red-600 hover:bg-red-700 transition text-white rounded-xl font-semibold shadow-lg text-center">
              ❤️ Heart Disease Prediction
            </Link>
            <Link to="/patient/parkinsons-prediction" className="px-6 py-3 bg-green-600 hover:bg-green-700 transition text-white rounded-xl font-semibold shadow-lg text-center">
